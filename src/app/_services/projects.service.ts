...
export class ProjectsService {
  ...
  projects: Project[] = [
    {id: 1, name: "React Kinoland", pictures: ["assets/img/img1.png","assets/img/img2.png","assets/img/img3.png"], projectWebLink: "https://react-kinoland.netlify.app/", projectRepoLink: "https://github.com/jmlinares2019/react_blockbuster", summary: "Movie library built in React 18 over Vite environment. Feel free to search and browse movies. The results and information are provided by theOMDB (Open Movie DataBase) API", description: "", tags: [Tag.REACT, Tag.JAVASCRIPT, Tag.HTML, Tag.SASS, Tag.NODEJS, Tag.RESTAPI, Tag.JSON, Tag.GIT]},
